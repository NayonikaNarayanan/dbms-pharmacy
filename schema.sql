...
SQL> CREATE TABLE PharmaCompany (
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Pharmacy(
        p_name IN VARCHAR,
...
SQL> CREATE OR REPLACE PROCEDURE Insert_PharmaCompany(
        c_name IN VARCHAR,
        c_phone IN VARCHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Doctor(
        d_aadhar IN CHAR,
        d_name IN VARCHAR,
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Patient(
        p_aadhar IN CHAR,
        p_name IN VARCHAR,
        p_address IN VARCHAR,
        p_age IN INT,
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Drug(
        t_name IN VARCHAR,
        c_name IN VARCHAR,
        formula IN VARCHAR
    ) AS
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Prescription(
        p_id IN INT,
        patient_id IN CHAR,
        doctor_id IN CHAR,
        p_date IN DATE
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Contract(
        con_id IN INT,
...
SQL> CREATE OR REPLACE PROCEDURE Insert_Sales(
        pharmacy_name IN VARCHAR,
...
SQL> CREATE OR REPLACE PROCEDURE Insert_PrescriptionDrug(
        presc_id IN INT,
        trade_name IN VARCHAR,
        company_name IN VARCHAR,
        qty IN INT
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Pharmacy(
        p_name IN VARCHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_PharmaCompany(
        c_name IN VARCHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Doctor(
        d_aadhar IN CHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Patient(
        p_aadhar IN CHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Drug(
        t_name IN VARCHAR,
        c_name IN VARCHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Sales(
        p_name IN VARCHAR,
        t_name IN VARCHAR,
        c_name IN VARCHAR
    ) AS
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Prescription(
        p_id IN INT
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Delete_PrescriptionDrug(
        p_id IN INT,
        t_name IN VARCHAR,
        c_name IN VARCHAR
    ) AS
...
SQL> CREATE OR REPLACE PROCEDURE Delete_Contract(
        c_id IN INT
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Update_Patient_Address(
        p_aadhar IN CHAR,
...
SQL> CREATE OR REPLACE PROCEDURE Update_Pharmacy_Phone(
        p_name IN VARCHAR,
...
SQL> CREATE OR REPLACE PROCEDURE Update_Contract_Supervisor(
        contract_id IN INT,
...
SQL> CREATE OR REPLACE PROCEDURE Prescription_Report(
        p_aadhar IN CHAR,
        start_date IN DATE,
        end_date IN DATE
    ) AS
...
SQL> CREATE OR REPLACE PROCEDURE Prescription_Details_By_Date(
        p_aadhar IN CHAR,
        presc_date IN DATE
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Get_Drugs_By_Company(
...
SQL> CREATE OR REPLACE PROCEDURE Print_Stock_Position(
        p_name IN VARCHAR
    ) AS
    BEGIN
        FOR rec IN (
...
SQL> CREATE OR REPLACE PROCEDURE Print_Contract_Details(
        p_name IN VARCHAR,
        c_name IN VARCHAR
    ) AS
    BEGIN
...
SQL> CREATE OR REPLACE PROCEDURE Print_Patients_For_Doctor(
        d_aadhar IN CHAR
    ) AS
    BEGIN
        FOR rec IN (
